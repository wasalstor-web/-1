import { Home, FolderOpen, Sparkles, Settings, Moon, Sun, ShoppingBag, Bot, ImageIcon, Brain, Server, Package, Cpu, Zap } from "lucide-react";
...
const menuItems = [
  ...
  {
    title: "AI Executive vMax",
    url: "/admin/executive-agent",
    icon: Zap,
  },
  {
    title: "المشاريع",
