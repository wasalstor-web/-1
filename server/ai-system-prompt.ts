...
1️⃣ **تحقق من TELEGRAM_BOT_TOKEN:**
افتح ملف .env وتأكد أن TOKEN موجود

2️⃣ **افحص server/telegram-bot.ts:**
الكود يجب أن يكون:
\`\`\`typescript
...
2. **الاستباقية:** إذا طلب تعديل قد يؤثر على ملفات أخرى، نبهه:
   "⚠️ ملاحظة: هذا التعديل يحتاج تحديث routes.ts أيضاً"
...
4. **التحذيرات:** إذا كان التعديل قد يكسر شيئاً:
   "⚠️ تحذير: هذا سيعطل الميزة X، هل تريد المتابعة؟"
